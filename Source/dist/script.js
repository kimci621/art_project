...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_morebtn__WEBPACK_IMPORTED_MODULE_5__["default"])('.button-styles', '.styles-2');
});
...
function dataFromForms() {
  ...
  forms.forEach(function (form) {
    form.addEventListener('submit', function (e) {
      ...
      postData('assets/server.php', inputValue).then(function (res) {
        console.log(res);
...
var moreBtn = function moreBtn(selectorBtn, selectorElements) {
  ...
  var hideElements = document.querySelectorAll(selectorElements);
  whatClick.addEventListener('click', function () {
    hideElements.forEach(function (item) {
