...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_validation__WEBPACK_IMPORTED_MODULE_4__["default"])('[name="name"]');
  Object(_modules_validation__WEBPACK_IMPORTED_MODULE_4__["default"])('[name="message"]');
  ...
  Object(_modules_mask__WEBPACK_IMPORTED_MODULE_3__["default"])("tel-mask");
...
var accordion = function accordion(triggers, contents) {
  var allTriggers = document.querySelectorAll(triggers);
  var allContent = document.querySelectorAll(contents);
...
var drop = function drop() {
  ...
  ['drop', 'dragenter', 'dragleave', 'dragover'].forEach(function (eventName) {
    uploads.forEach(function (upload) {
      upload.addEventListener(eventName, preventDef); // console.log(upload.previousElementSibling);
    });
  });
...
/* harmony import */ var _services_requests__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./services/requests */ "./src/js/modules/services/requests.js");
...
function dataFromForms() {
  ...
  var inputJpgName = document.querySelectorAll('[name=upload]');
  var messages = {
  ...
  var clearInputs = function clearInputs() {
    ...
    inputJpgName.forEach(function (input) {
      input.value = "";
    });
  };

  inputJpgName.forEach(function (item) {
    item.addEventListener('input', function () {
      var itemName = item.files[0].name;
      item.previousElementSibling.textContent = "".concat(itemName);
    });
  ...
  forms.forEach(function (form) {
    form.addEventListener('submit', function (e) {
      ...
      statusText.textContent = "".concat(messages.loadingText);
      statusMessage.appendChild(statusText);
      var inputValue = new FormData(form);
      Object(_services_requests__WEBPACK_IMPORTED_MODULE_5__["postData"])('assets/server.php', inputValue).then(function (res) {
        console.log(res);
        statusImg.setAttribute('src', messages.ok);
        statusText.textContent = "".concat(messages.successText);
      }).catch(function () {
        statusImg.setAttribute('src', messages.fail);
        statusText.textContent = "".concat(messages.failureText);
      }).finally(function () {
        clearInputs();
        setTimeout(function () {
...
/* harmony default export */ __webpack_exports__["default"] = (dataFromForms);
...
var mask = function mask(selector) {
  var element = document.getElementById("".concat(selector));
  var maskOptions = {
...
var modal = function modal() {
  function bindModal(openTrigger, Modalselector, closeTrigger) {
    ...
    var open = document.querySelectorAll(openTrigger),
    ...
    function endPageModal(selector) {
      window.addEventListener('scroll', function () {
        var allScrollHeight = Math.max(document.documentElement.scrollHeight, document.body.scrollHeight);
        var scrollingHeight = window.pageYOffset + document.documentElement.clientHeight;
  ...
  function openModalTimer(selector, time) {
    ...
    setTimeout(function () {
      ...
      if (displayStatus !== "true") {
        ...
        document.body.style.overflow = 'hidden';
        document.body.style.marginRight = "".concat(sw, "px");
      }
    }, time);
  }
  ...
  bindModal('.fixed-gift', '.popup-gift', '.popup-gift .popup-close', true); // openModalTimer('.popup-consultation', 60000);
};
...
var moreBtn = function moreBtn(selectorBtn, selectorElements) {
  var whatClick = document.querySelector(selectorBtn);
  var parentSelector = document.querySelector(selectorElements);
  whatClick.addEventListener('click', function () {
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_3__["getData"])('assets/db.json').then(function (res) {
      return createElems(res.styles);
    }).catch(function (err) {
      return alert("\u041E\u0448\u0438\u0431\u043A\u0430 \u0441\u0435\u0440\u0432\u0435\u0440\u0430, \u043F\u0440\u0438\u0447\u0438\u043D\u0430: ".concat(err));
    });
    this.remove();
  });
...
/* harmony default export */ __webpack_exports__["default"] = (moreBtn);

/***/ }),

/***/ "./src/js/modules/pictureSwap.js":
/*!***************************************!*\
  !*** ./src/js/modules/pictureSwap.js ***!
  \***************************************/
/*! exports provided: default */
...
var pictureSwap = function pictureSwap(imgSelector) {
...
/* harmony default export */ __webpack_exports__["default"] = (pictureSwap);
